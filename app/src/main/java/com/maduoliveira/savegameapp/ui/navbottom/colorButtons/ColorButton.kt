package com.maduoliveira.savegameapp.ui.navbottom.colorButtons
...
import com.maduoliveira.savegameapp.ui.navbottom.noRippleClickable
import com.maduoliveira.savegameapp.ui.navbottom.toPxf
...
fun ColorButton(
    ...
    Box(
        ...
        Image(
            modifier = Modifier
                .offset(x = background.offset.x + with(density) { offset.toDp() }, y = background.offset.y)
